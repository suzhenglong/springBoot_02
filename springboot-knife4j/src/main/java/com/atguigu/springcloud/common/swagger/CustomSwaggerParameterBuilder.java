 ...
 * @Title: CustomSwaggerParameterBuilder
 * @Description: 自定义ExpandedParameterBuilderPlugin，主要是修正源码query传入请求参数postion无效这里，将postion赋值给order
 * @date 2019-09-22 14:31
 */
...
public class CustomSwaggerParameterBuilder implements ExpandedParameterBuilderPlugin {
    ...
    public void apply(ParameterExpansionContext context) {
        Optional<ApiModelProperty> apiModelPropertyOptional = context
                .findAnnotation(ApiModelProperty.class);
    ...
    private void fromApiModelProperty(ParameterExpansionContext context,
    ...
    private ParameterBuilder maybeSetParameterName(ParameterExpansionContext context,
    ...
    private AllowableValues allowableValues(final Optional<String> optionalAllowable,
                                            Class<?> fieldType) {
    ...
    private List<String> getEnumValues(final Class<?> subject) {
        return Lists
                .transform(Arrays.asList(subject.getEnumConstants()), new Function<Object, String>() {
                    @Override
